...
export const addSeller = catchAsync(async (req, res, next) => {
...
export const requireApprovedSeller = catchAsync(async (req, res, next) => {
...
export const updateSellerStatus = catchAsync(async (req, res, next) => {
  if (!['REJECTED', 'APPROVED'].includes(req.body.status)) {
